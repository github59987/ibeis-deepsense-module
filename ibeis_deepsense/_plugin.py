...
# ibs.ibeis_deepsense_hello_world() in this file, you can call
#
#     python -m ibeis_deepsense._plugin --test-ibeis_deepsense_hello_world:0
#
...
#
#     python -m ibeis_deepsense._plugin --test-ibeis_deepsense_hello_world
#
...
#
#     python -m ibeis_deepsense._plugin --test-ibeis_deepsense_file_download:1 --profile
#
...
# something like this:
#
#     **[TEST.FINISH] ibeis_deepsense_file_download -- SUCCESS
#     [util_io] * Writing to text file: timeings.txt
#     L_____________________________________________________________
#     +-------
#     | finished testing fpath='ibeis_deepsense/ibeis_deepsense/_plugin.py'
#     | passed 1 / 1
#     L-------
#     Dumping Profile Information
#      -1.00 seconds - None                                             :None:None
#       0.14 seconds - ibeis_deepsense_file_download:ibeis_deepsense/ibeis_deepsense/_plugin.py:536
...
#     587         2     136968.0  68484.0     99.9          file_filepath = ut.grab_file_url(file_url, appname='ibeis_deepsense', check_hash=True)
#     588
...
# that uses ut.embed() in the ibs.ibeis_deepsense_hello_world()
...
def ibeis_deepsense_hello_world(ibs):
    r"""
    ...
    CommandLine:
        ...
        python -m ibeis_deepsense._plugin --test-ibeis_deepsense_hello_world:1
    ...
    Example0:
        ...
        >>> resp = ibs.ibeis_deepsense_hello_world()
        >>>
        ...
        >>> })
        [ibeis_deepsense] hello world with IBEIS controller <IBEISController(testdb_identification) with UUID 1654bdc9-4a14-43f7-9a6a-5f10f2eaa279>
        {
            'annotations': 70,
    ...
    """
    args = (ibs, )
    resp = '[ibeis_deepsense] hello world with IBEIS controller %r' % args
    return resp


@profile
@register_ibs_method
def ibeis_deepsense_file_download(file_url):
    r"""
    ...
    CommandLine:
        python -m ibeis_deepsense._plugin --test-ibeis_deepsense_file_download

        python -m ibeis_deepsense._plugin --test-ibeis_deepsense_file_download:0

        python -m ibeis_deepsense._plugin --test-ibeis_deepsense_file_download:1
    ...
    Example0:
        ...
        >>> file_filepath = ibeis_deepsense_file_download(file_url)
    ...
    Example1:
        ...
        >>> file_filepath_ = ibeis_deepsense_file_download(file_url)
    ...
    with ut.Timer() as timer:
        file_filepath = ut.grab_file_url(file_url, appname='ibeis_deepsense', check_hash=True)
...
class IdentificationExampleImageHashConfig(dt.Config):  # NOQA
    """
    CommandLine:
        python -m ibeis_deepsense._plugin --test-IdentificationExampleImageHashConfig

        python -m ibeis_deepsense._plugin --test-IdentificationExampleImageHashConfig:0

        python -m ibeis_deepsense._plugin --test-IdentificationExampleImageHashConfig:1
...
@register_preproc_image(
    ...
    chunksize=4)
def ibeis_deepsense_image_hash(depc, gid_list, config):
    r"""
    ...
    CommandLine:
        python -m ibeis_deepsense._plugin --test-ibeis_deepsense_image_hash
...
class IdentificationExampleImageHashSumConfig(dt.Config):  # NOQA
    """
    CommandLine:
        python -m ibeis_deepsense._plugin --test-IdentificationExampleImageHashSumConfig
...
@register_preproc_image(
    ...
    fname='identification_example',
    chunksize=100)
def ibeis_deepsense_image_hash_sum(depc, image_hash_rowid_list, config):
    r"""
    ...
    CommandLine:
        python -m ibeis_deepsense._plugin --test-ibeis_deepsense_image_hash_sum
...
class IdentificationExampleImageHashProdConfig(dt.Config):  # NOQA
    """
    CommandLine:
        python -m ibeis_deepsense._plugin --test-IdentificationExampleImageHashProdConfig
...
@register_preproc_image(
    ...
    fname='identification_example',
    chunksize=100)
def ibeis_deepsense_image_hash_prod(depc, image_hash_rowid_list, config):
    r"""
    ...
    CommandLine:
        python -m ibeis_deepsense._plugin --test-ibeis_deepsense_image_hash_prod
...
class IdentificationExampleOracleRequest(dt.base.VsOneSimilarityRequest):  # NOQA
    ...
    CommandLine:
        python -m ibeis_deepsense._plugin --test-IdentificationExampleOracleRequest
...
class IdentificationExampleOracleConfig(dt.Config):  # NOQA
    """
    CommandLine:
        python -m ibeis_deepsense._plugin --test-IdentificationExampleOracleConfig
...
@register_preproc_annot(
    ...
    fname='identification_example',
    chunksize=None)
def ibeis_deepsense_oracle(depc, qaid_list, daid_list, config):
    r"""
    ...
    CommandLine:
        python -m ibeis_deepsense._plugin --test-ibeis_deepsense_oracle:0

        python -m ibeis_deepsense._plugin --test-ibeis_deepsense_oracle:0 --show

        python -m ibeis_deepsense._plugin --test-ibeis_deepsense_oracle:1

        python -m ibeis_deepsense._plugin --test-ibeis_deepsense_oracle:2

        python -m ibeis_deepsense._plugin --test-ibeis_deepsense_oracle:3
